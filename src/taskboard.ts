import type { ExecutorTarget, Project, TaskboardStatus, TaskboardTask } from "./api";
...
export function executorOnline(target: ExecutorTarget, projects: Project[]): boolean {
  return target.kind === "tenant" || projects.some((project) => project.id === target.projectId && project.executor_status === "online");
}
